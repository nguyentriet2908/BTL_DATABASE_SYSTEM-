...
<body>
    <div class="app">
        ...
        <div style="background-color:aliceblue ;height: 900px;font-size: larger;">
        </div>
        <?php if(isset($_GET['page'])) { include "footer.php";} ?>
    </div>
</body>
