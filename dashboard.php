...
<body>
    <div class="app">
            ...
            <div class="grid">
                <nav class="header__navbar">
                    <ul class="header__navbar-list">
                        <li class="header__navbar-item"><a href="" style="text-decoration: none;color: white;font-size:large;">Music.com</a></li>
                        <li class="header__navbar-item"><a href="" style="text-decoration: none;color: white;font-size:large;">Hotline Contact</a></li>
                        <?php

                        $page = isset($_GET['page']) ? $_GET['page'] : 'home';
                        echo "Current page: $page"; // Debug statement
                        if ($page === 'products') :
                        ?>
                    ...
                    <ul class="header__navbar-list">
                        ...
                        if (isset($_SESSION['username'])) {
                            echo '<li class="header__navbar-item">
                                <a href="dashboard.php" class="header__navbar-item-link" style="font-size:large;">Dashboard</a>
                            </li>
        ...
        <div style="background-color:aliceblue ;height: 1000px;font-size: larger;"></div>
